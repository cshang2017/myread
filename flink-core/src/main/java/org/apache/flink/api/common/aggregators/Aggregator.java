 ...
 * {@link ConvergenceCriterion}. 
 * ! In contrast to the {@link org.apache.flink.api.common.accumulators.Accumulator} (whose result is available at the * end of a job, the aggregators are computed once per iteration superstep. 
 * Their value can be used to check for convergence (at the end
